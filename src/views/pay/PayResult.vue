...
<template>
  <div class="payResult-container">
    ...
    <div v-else class="pay-div">
      <div class="pay-money">
        <div class="paymentAmount">合计：
          <span style="color: #995454">¥{{ order.paymentAmount.toFixed(2) }}元</span>
        </div>
        <div class="pay-money-cancelTime">距订单关闭还有{{ getCancelTime(order) }}分钟</div>
      </div>
