      ...
      <section class="menu_left" id="wrapper_menu" ref="wrapperMenu">
        <ul>
          <li
            ...
            :class="{ active: item.clzId == currentClzId }"
            @click="selectClz(item.clzId)"
            class="menu_left_li"
            :id="'clz' + item.clzId"
          >
              ...
              <div class="good-container">
                ...
                >
                  <div class="goodImg-div">
                    ...
                    <div
                      v-show="it.originalPrice > it.price"
                      style="position: absolute;left: 0;bottom: 0"
                    >
                      <span
                        class="cutPrice"
                        :style="
                          it.originalPrice - it.price > 100
                            ? it.originalPrice - it.price > 300
  ...
  mounted: function() {
    this.$nextTick(function() {
      ...
      this.containerHeight =
        window.innerHeight -
        window.document.getElementById('header').clientHeight -
      ...
      this.goodScroll.on('scroll', (pos) => {
        ...
        if (this.clzSigns.length == 0) {
          ...
          if (
            clzs[clzs.length - 1].clientHeight <
            window.document.getElementById('wrapper_good').clientHeight / 3 *
              2
          ) {
            this.placeholderHeight =
              window.document.getElementById('wrapper_good').clientHeight / 2 +
              'px'
          }
