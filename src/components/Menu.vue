...
<template>
  <div class="menu" id="menu">
    <div
      class="m-index"
      @click="toIndex"
      :class="{ indexActive: $route.path.indexOf('index') !== -1 }"
    >
      首页
    </div>
    <div
      class="m-clz"
      @click="toClz"
      :class="{ clzActive: $route.path.indexOf('clz') !== -1 }"
    >
      分类
    </div>
    <div
      class="m-cart"
      @click="toCart"
      :class="{ cartActive: $route.path.indexOf('cart') !== -1 }"
    >
      购物车
    </div>
    <div
      class="m-personal"
      @click="toPersonal"
      :class="{ personalActive: $route.path.indexOf('personal') !== -1 }"
    >
      我的
    </div>
  </div>
