...
; (function ($, window, document, undefined) {
  var cityObj = function (el, option) {
    // 默认参数
    this.defaultOptions = {
      dataUrl: '/shopping/js/area.json', // 数据库地址
    ...
    var loadDataHandler = {
      ...
      areaData: function () {
        ...
        //   }
        // })
        dataHanlder.splitData(areas) // 这里调用"数据处理" dataHanlder 对象的 splitData 方法，将省市县(区)分别存入相应对象
      },
      // 加载乡镇数据
      townData: function (callback) {
        if (currentArea && currentArea.code) {
          ...
          $.ajax({
            url: 'https://www.tdxiov.com:28888/shopping/address/getStreet?areaCode=' + currentArea.code,
            dataType: 'json',
