...
; (function ($, window, document, undefined) {
  var cityObj = function (el, option) {
    ...
    var $container = $('#' + this.currentOptions.containerId)
    // 地址选择容器对象

    var $province = $('#' + this.currentOptions.provinceField)
    // 当前的省级选择

    var $lastProvince = $('#last' + this.currentOptions.provinceField)
    // 上次成功选择的省级区域

    var $city = $('#' + this.currentOptions.cityField)
    // 市级选择

    var $lastCity = $('#last' + this.currentOptions.cityField)
    // 上次选择的市级区域

    var $area = $('#' + this.currentOptions.areaField)
    // 区县选择

    var $lastArea = $('#last' + this.currentOptions.areaField)
    // 上次选择的区县

    var $town = $('#' + this.currentOptions.townField)
    // 乡镇街道选择

    var $lastTown = $('#last' + this.currentOptions.townField)
    // 上次选择的乡镇街道
